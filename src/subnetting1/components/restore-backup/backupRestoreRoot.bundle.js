...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 3);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/sass-loader/dist/cjs.js??ref--6-3!./Terminate.scss */ 11);
...
/* 12 */
/*!*********************************************************!*\
  !*** ./src/components/restore-backup/BackupRestore.css ***!
  \*********************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
/***/ (function(module, exports, __webpack_require__) {
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 3);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!./BackupRestore.css */ 13);
...
/* 13 */
/*!*********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--5-1!./src/components/restore-backup/BackupRestore.css ***!
  \*********************************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "/**\n * Mailvelope - secure email with OpenPGP encryption for Webmail\n * Copyright (C) 2015 Mailvelope GmbH\n */\n\nbody {\n  margin: 0;\n}\n\n.form-control.flex-digit {\n  width:  5em;\n  height: auto;\n  text-align: center;\n  font-size: 12px;\n  padding: 6px;\n}\n\n.form-control.flex-digit.last {\n  width: 2em;\n  min-width: 3em;\n}\n\n.flex-separator {\n  width: 1em;\n  text-align: center;\n  display: block;\n}\n", ""]);
// Exports
module.exports = exports;
...
/* 14 */
/*!************************************************************************!*\
  !*** ./src/components/restore-backup/backupRestoreRoot.js + 9 modules ***!
  \************************************************************************/
/*! no exports provided */
/*! all exports used */
...
var Terminate = __webpack_require__(10);
...
// EXTERNAL MODULE: ./src/components/restore-backup/BackupRestore.css
var restore_backup_BackupRestore = __webpack_require__(12);

// CONCATENATED MODULE: ./src/components/restore-backup/BackupRestore.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['key_recovery_failed', 'restore_backup_dialog_button', 'restore_backup_dialog_headline', 'restore_password_dialog_button', 'restore_password_dialog_headline', 'wrong_restore_code']);
class BackupRestore_BackupRestore extends external_React_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      password: false,
    ...
    this.port = EventHandler_EventHandler.connect(`restoreBackupDialog-${this.props.id}`, this);
  ...
  registerEventListeners() {
    this.port.on('set-password', msg => this.setState({
  ...
  handleError(msg) {
    ...
    switch (msg.error.code) {
      case 'WRONG_RESTORE_CODE':
        ...
        error = new Error(map.wrong_restore_code);
        break;

      default:
        error = new Error(map.key_recovery_failed);
    }
  ...
  handleClick() {
    ...
    this.setState({
      error: null
    }, () => this.port.emit('restore-backup-code', {
  ...
  render() {
    return external_React_default.a.createElement(SecurityBG_SecurityBG, {
    ...
    }, this.state.password !== false ? external_React_default.a.createElement(external_React_default.a.Fragment, null, external_React_default.a.createElement("h4", {
      className: "mb-2"
    }, map.restore_password_dialog_headline), external_React_default.a.createElement("input", {
      type: this.state.hidePassword ? 'password' : 'text',
      value: this.state.password,
      className: "form-control flex-grow-1 my-3 text-monospace",
      readOnly: true
    }), external_React_default.a.createElement("button", {
      type: "button",
      onClick: () => this.setState({
        hidePassword: false
      }, () => this.logUserInput('security_log_restore_backup_click')),
      id: "restorePasswordBtn",
      className: "btn btn-primary align-self-end",
      disabled: !this.state.hidePassword
    }, map.restore_password_dialog_button)) : external_React_default.a.createElement(external_React_default.a.Fragment, null, external_React_default.a.createElement("h4", {
      className: "mb-2"
    }, map.restore_backup_dialog_headline), external_React_default.a.createElement("div", {
      ref: ref => this.digits = ref,
      className: "d-inline-flex align-items-center justify-content-center my-3"
    }, external_React_default.a.createElement("input", {
      type: "text",
      className: "form-control flex-digit text-monospace",
      maxLength: "5",
      autoFocus: true
    }), external_React_default.a.createElement("span", {
      ...
      type: "text",
      className: "form-control flex-digit last text-monospace",
      maxLength: "1"
    })), this.state.error && external_React_default.a.createElement(Alert, {
      type: "danger"
    }, this.state.error.message), external_React_default.a.createElement("button", {
      type: "button",
      onClick: this.handleClick,
      className: "btn btn-primary align-self-end",
      disabled: !this.state.code
    }, map.restore_backup_dialog_button)))))), this.state.terminate && external_React_default.a.createElement(Terminate_Terminate, null));
  }

}
BackupRestore_BackupRestore.propTypes = {
  id: prop_types_default.a.string
};
// CONCATENATED MODULE: ./src/components/restore-backup/backupRestoreRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default.a.render(external_React_default.a.createElement(BackupRestore_BackupRestore, {
    id: id
