...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 3);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/sass-loader/dist/cjs.js??ref--6-3!./Spinner.scss */ 11);
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 3);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/sass-loader/dist/cjs.js??ref--6-3!./Terminate.scss */ 13);
...
/* 14 */
/*!****************************************************************!*\
  !*** ./src/components/generate-key/genKeyRoot.js + 10 modules ***!
  \****************************************************************/
/*! no exports provided */
/*! all exports used */
...
// CONCATENATED MODULE: ./src/components/util/DefinePassword.js
/**
 * Copyright (C) 2016-2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['key_gen_pwd', 'key_gen_pwd_empty', 'key_gen_pwd_reenter', 'key_gen_pwd_unequal', 'key_gen_pwd_match']);
class DefinePassword_DefinePassword extends external_React_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordCheck: ''
  ...
  render() {
    return external_React_default.a.createElement("div", null, external_React_default.a.createElement("div", {
    ...
    }, map.key_gen_pwd), external_React_default.a.createElement("input", {
      ...
      placeholder: this.props.hideLabels ? map.key_gen_pwd : ''
    }), this.props.errors.password && external_React_default.a.createElement("div", {
      className: "invalid-feedback"
    }, this.props.errors.password.message !== '' ? this.props.errors.password.message : map.key_gen_pwd_empty)), external_React_default.a.createElement("div", {
      className: "form-group"
    }, external_React_default.a.createElement("label", {
      htmlFor: "passwordCheck",
      className: this.props.hideLabels ? 'sr-only' : ''
    }, map.key_gen_pwd_reenter), external_React_default.a.createElement("input", {
      ...
      id: "passwordCheck",
      disabled: this.props.disabled,
      placeholder: this.props.hideLabels ? map.key_gen_pwd_reenter : ''
    }), this.props.errors.passwordCheck && external_React_default.a.createElement("div", {
      className: "invalid-feedback"
    }, map.key_gen_pwd_unequal)));
  }

}
DefinePassword_DefinePassword.propTypes = {
  ...
  hideLabels: prop_types_default.a.bool
};
DefinePassword_DefinePassword.defaultProps = {
  focus: false,
  hideLabels: false
};
// EXTERNAL MODULE: ./src/components/util/Spinner.scss
var util_Spinner = __webpack_require__(10);
...
var Terminate = __webpack_require__(12);
...
// CONCATENATED MODULE: ./src/components/generate-key/GenKey.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['keygen_dialog_password_error_length', 'keygen_dialog_password_placeholder', 'keygen_dialog_prolog', 'keygen_waiting_description', 'keygen_waiting_headline']);
const PWD_MIN_LENGTH = 4;
class GenKey_GenKey extends external_React_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      password: '',
    ...
    this.port = EventHandler_EventHandler.connect(`keyGenDialog-${this.props.id}`, this);
  ...
  registerEventListeners() {
    this.port.on('check-dialog-inputs', () => this.port.emit('input-check', {
      isValid: this.validate(),
      pwd: this.state.password
    }));
    this.port.on('show-password', () => this.setState({
      waiting: false
    }));
    this.port.on('show-waiting', () => this.setState({
      waiting: true
    }));
  ...
  validate() {
    ...
    if (this.state.password.length < PWD_MIN_LENGTH) {
      errors.password = new Error(get('keygen_dialog_password_error_length', [PWD_MIN_LENGTH]));
    }
  ...
  render() {
    return external_React_default.a.createElement(SecurityBG_SecurityBG, {
      ...
      className: "modal-dialog d-flex align-items-center h-100 mw-100 m-0"
    }, external_React_default.a.createElement("div", {
      ...
      className: "modal-body d-flex flex-column overflow-auto p-4"
    }, this.state.waiting ? external_React_default.a.createElement(external_React_default.a.Fragment, null, external_React_default.a.createElement(Spinner_Spinner, {
      style: {
        margin: '10px auto 20px auto'
      }
    }), external_React_default.a.createElement("h4", {
      className: "align-self-center text-center"
    }, map.keygen_waiting_headline), external_React_default.a.createElement("p", {
      className: "align-self-center text-center mb-0"
    }, map.keygen_waiting_description)) : external_React_default.a.createElement(external_React_default.a.Fragment, null, external_React_default.a.createElement("h4", {
      className: "mb-4"
    }, map.keygen_dialog_prolog), external_React_default.a.createElement(DefinePassword_DefinePassword, {
...
GenKey_GenKey.propTypes = {
  id: prop_types_default.a.string
};
// CONCATENATED MODULE: ./src/components/generate-key/genKeyRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default.a.render(external_React_default.a.createElement(GenKey_GenKey, {
    id: id
