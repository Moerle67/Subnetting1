...
/* 12 */
/*!****************************************************************!*\
  !*** ./src/components/import-key/importKeyRoot.js + 9 modules ***!
  \****************************************************************/
/*! no exports provided */
/*! all exports used */
...
// CONCATENATED MODULE: ./src/components/import-key/ImportKey.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['key_import_default_headline', 'key_import_default_description', 'key_import_invalidated_description', 'keyring_confirm_keys', 'keygrid_keyid', 'keygrid_user_name', 'keygrid_user_email', 'keygrid_key_fingerprint', 'form_confirm', 'form_cancel']);
class ImportKey_ImportKey extends external_React_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      waiting: true,
    ...
    this.registerEventListeners(); // emit event to backend that key import dialog has initialized
  ...
  render() {
    return external_React_default.a.createElement(SecurityBG_SecurityBG, {
      ...
      className: "modal d-block p-5"
    }, external_React_default.a.createElement("div", {
      className: "modal-dialog h-100 mw-100 m-0"
    }, external_React_default.a.createElement("div", {
      className: "modal-content shadow-lg border-0 h-100"
      ...
      className: "modal-header justify-content-center border-0 p-4 flex-shrink-0"
    }, external_React_default.a.createElement("h4", {
      className: "modal-title"
    }, map.key_import_default_headline)), external_React_default.a.createElement("div", {
      className: "modal-body overflow-auto py-0 px-4"
    }, external_React_default.a.createElement("p", null, !this.state.invalidated ? map.key_import_default_description : get('key_import_invalidated_description', [this.state.key.email ? this.state.key.email : this.state.key.name])), !this.state.showError ? external_React_default.a.createElement("div", {
      className: "table-responsive"
    }, external_React_default.a.createElement("table", {
      className: "table table-custom"
    }, external_React_default.a.createElement("thead", null, external_React_default.a.createElement("tr", null, external_React_default.a.createElement("th", null), external_React_default.a.createElement("th", null, map.keygrid_keyid), external_React_default.a.createElement("th", null, map.keygrid_user_name), external_React_default.a.createElement("th", null, map.keygrid_user_email), external_React_default.a.createElement("th", null, map.keygrid_key_fingerprint))), external_React_default.a.createElement("tbody", null, this.state.key.users.map((user, userIndex) => external_React_default.a.createElement("tr", {
      key: userIndex,
      tabIndex: "0",
      "aria-haspopup": "true",
      className: userIndex === 0 && this.state.key.users.length > 1 ? 'accent' : ''
    }, external_React_default.a.createElement("td", {
      className: `align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, userIndex === 0 && external_React_default.a.createElement("span", {
      className: `icon icon-${this.state.key.type === 'public' ? 'key' : 'key-pair'}`,
      style: {
        fontSize: '1.25rem'
      }
    })), external_React_default.a.createElement("td", {
      className: `monospaced text-nowrap small text-break align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, userIndex === 0 ? this.state.key.keyId : ''), external_React_default.a.createElement("td", {
      className: `align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, user.name), external_React_default.a.createElement("td", {
      className: `align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, user.email), external_React_default.a.createElement("td", {
      style: {
        maxWidth: '180px'
      },
      className: `monospaced text-muted small text-break align-middle ${userIndex !== 0 ? 'border-top-0' : ''}`
    }, userIndex === 0 ? formatFpr(this.state.key.fingerprint) : '')))))) : external_React_default.a.createElement(Alert, {
      header: this.state.error.header,
      type: this.state.error.type
    }, this.state.error.message)), external_React_default.a.createElement("div", {
      className: "modal-footer justify-content-center border-0 p-4 flex-shrink-0"
    }, external_React_default.a.createElement("div", {
      className: "btn-bar"
    ...
    }, map.keyring_confirm_keys))))))));
  }

}
ImportKey_ImportKey.propTypes = {
  id: prop_types_default.a.string,
  isContainer: prop_types_default.a.bool
};
// CONCATENATED MODULE: ./src/components/import-key/importKeyRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  external_ReactDOM_default.a.render(external_React_default.a.createElement(ImportKey_ImportKey, {
    id: id
