...
var _CSSTransition = _interopRequireDefault(__webpack_require__(/*! ./CSSTransition */ 21));

var _ReplaceTransition = _interopRequireDefault(__webpack_require__(/*! ./ReplaceTransition */ 26));
...
var _reactDom = _interopRequireDefault(__webpack_require__(/*! react-dom */ 4));
...
var _ChildMapping = __webpack_require__(/*! ./utils/ChildMapping */ 27);
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 5);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!./encryptedForm.css */ 16);
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 5);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!./SecurityBG.css */ 18);
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 5);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/sass-loader/dist/cjs.js??ref--6-3!./Spinner.scss */ 20);
...
var _addClass = _interopRequireDefault(__webpack_require__(/*! dom-helpers/class/addClass */ 22));

var _removeClass = _interopRequireDefault(__webpack_require__(/*! dom-helpers/class/removeClass */ 25));
...
var _hasClass = _interopRequireDefault(__webpack_require__(/*! ./hasClass */ 24));
...
var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ 5);
            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/sass-loader/dist/cjs.js??ref--6-3!./Terminate.scss */ 29);
...
/* 30 */
/*!*************************************************************************!*\
  !*** ./src/components/encrypted-form/encryptedFormRoot.js + 27 modules ***!
  \*************************************************************************/
/*! no exports provided */
/*! all exports used */
...
var encryptedForm = __webpack_require__(15);

// EXTERNAL MODULE: ./src/components/util/SecurityBG.css
var util_SecurityBG = __webpack_require__(17);
...
var util_Spinner = __webpack_require__(19);
...
var react_transition_group = __webpack_require__(8);
...
function (_React$Component) {
  ...
  _proto.renderModalDialog = function renderModalDialog() {
    ...
    return external_React_default.a.createElement("div", _extends({}, attributes, {
  ...
  _proto.render = function render() {
    ...
    if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
      ...
      var Backdrop = backdrop && (hasTransition ? external_React_default.a.createElement(es_Fade, _extends({}, backdropTransition, {
        in: isOpen && !!backdrop,
        cssModule: cssModule,
      ...
      return external_React_default.a.createElement(es_Portal, {
        node: this._element
      }, external_React_default.a.createElement("div", {
        className: mapToCssModules(wrapClassName)
      }, external_React_default.a.createElement(es_Fade, _extends({}, modalAttributes, modalTransition, {
        in: isOpen,
...
var ModalHeader_ModalHeader = function ModalHeader(props) {
  ...
  return external_React_default.a.createElement(WrapTag, _extends({}, attributes, {
    className: classes
  }), external_React_default.a.createElement(Tag, {
...
/* harmony default export */ var es_ModalBody = (ModalBody_ModalBody);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (close && typeof attributes.children === 'undefined') {
      attributes.children = external_React_default.a.createElement("span", {
        "aria-hidden": true
      }, "\xD7");
    }
...
// CONCATENATED MODULE: ./src/components/util/Modal.js
/**
 * Copyright (C) 2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function util_Modal_Modal(props) {
  return external_React_default.a.createElement(es_Modal, {
  ...
  }, !props.hideHeader && (props.header || external_React_default.a.createElement(es_ModalHeader, {
    toggle: typeof props.toggle === 'function' ? props.toggle : undefined,
    className: props.headerClass
  }, props.title)), external_React_default.a.createElement(es_ModalBody, null, props.children), !props.hideFooter && (props.footer || external_React_default.a.createElement(es_ModalFooter, null, props.toggle && external_React_default.a.createElement(es_Button, {
    color: "secondary",
    onClick: props.toggle
  }, map.form_cancel), external_React_default.a.createElement(es_Button, {
    color: "primary",
    onClick: props.onOk
  }, map.form_ok))));
}
util_Modal_Modal.propTypes = {
  className: prop_types_default.a.string,
...
var Terminate = __webpack_require__(28);
...
class encryptedForm_EncryptedForm extends external_React_default.a.Component {
  ...
  render() {
    if (this.state.waiting) {
      return external_React_default.a.createElement(util_Modal_Modal, {
    ...
    return external_React_default.a.createElement(SecurityBG_SecurityBG, {
      ...
      className: "card-body"
    }, this.state.error ? external_React_default.a.createElement(Alert, {
    ...
    }, formatFpr(this.state.recipientFpr))))))), this.state.terminate && external_React_default.a.createElement(Terminate_Terminate, null));
  }
...
document.addEventListener('DOMContentLoaded', encryptedFormRoot_init);
mapToLocal();

function encryptedFormRoot_init() {
