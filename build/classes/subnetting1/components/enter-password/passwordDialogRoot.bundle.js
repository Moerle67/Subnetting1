...
/* 12 */
/*!*************************************************************************!*\
  !*** ./src/components/enter-password/passwordDialogRoot.js + 9 modules ***!
  \*************************************************************************/
/*! no exports provided */
/*! all exports used */
...
// CONCATENATED MODULE: ./src/components/enter-password/PasswordDialog.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
register(['pwd_dialog_header', 'pwd_dialog_pwd_please', 'pwd_dialog_reason_decrypt', 'pwd_dialog_reason_sign', 'pwd_dialog_reason_revoke', 'pwd_dialog_reason_add_user', 'pwd_dialog_reason_revoke_user', 'pwd_dialog_reason_set_exdate', 'pwd_dialog_reason_editor', 'pwd_dialog_reason_create_backup', 'pwd_dialog_reason_create_draft', 'pwd_dialog_cache_pwd', 'pwd_dialog_wrong_pwd', 'form_ok', 'form_cancel']);
class PasswordDialog_PasswordDialog extends external_React_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      keyId: '',
    ...
    this.port = EventHandler_EventHandler.connect(`pwdDialog-${this.props.id}`, this);
  ...
  setInitData({
    ...
    this.setState({
      keyId,
      userId,
      reason: reason !== '' ? map[reason.toLowerCase()] : '',
      cache,
      waiting: false
    });
  }
  ...
  render() {
    return external_React_default.a.createElement(SecurityBG_SecurityBG, {
    ...
    }, map.pwd_dialog_header)), external_React_default.a.createElement("div", {
      className: "modal-body overflow-auto py-0 px-4"
    }, external_React_default.a.createElement(Alert, {
      type: "info",
      className: "d-flex align-items-center overflow-hidden pl-2"
    }, external_React_default.a.createElement("span", {
      className: "icon icon-key lead text-info mr-2"
    }), external_React_default.a.createElement("div", null, external_React_default.a.createElement("b", null, this.state.userId), external_React_default.a.createElement("br", null), this.state.keyId)), this.state.reason && external_React_default.a.createElement("p", null, this.state.reason), external_React_default.a.createElement("div", {
      ...
      onPaste: e => {
        e.preventDefault();
        this.onInputPaste(e.clipboardData.getData('Text'));
      },
      onChange: e => this.onInputPaste(e.target.value),
      className: `form-control text-monospace ${this.state.showError ? 'is-invalid' : ''}`
    }), external_React_default.a.createElement("div", {
      className: this.state.showError ? 'invalid-feedback' : 'd-none'
    }, map.pwd_dialog_wrong_pwd)), external_React_default.a.createElement("div", null, external_React_default.a.createElement("div", {
      className: "custom-control custom-checkbox"
    }, external_React_default.a.createElement("input", {
      type: "checkbox",
      checked: this.state.cache,
      onChange: e => this.onChangeCache(e.target.checked),
      className: "custom-control-input",
      id: "remember"
    }), external_React_default.a.createElement("label", {
      className: "custom-control-label",
      htmlFor: "remember"
    }, map.pwd_dialog_cache_pwd)))), external_React_default.a.createElement("div", {
...
PasswordDialog_PasswordDialog.propTypes = {
  id: prop_types_default.a.string
};
// CONCATENATED MODULE: ./src/components/enter-password/passwordDialogRoot.js
/**
 * Copyright (C) 2019 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
function init() {
  ...
  addDocumentTitle(`Mailvelope - ${map.pwd_dialog_header}`); // component used as a container (client API)

  const root = document.createElement('div');
  external_ReactDOM_default.a.render(external_React_default.a.createElement(PasswordDialog_PasswordDialog, {
    id: id
